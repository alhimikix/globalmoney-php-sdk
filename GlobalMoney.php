<?php
/**
 * Payment method global money process
 *
 * @author      GlobalMoney <support@globalmoney.cash>
 */
class GlobalMoney
{
    ...
    private $_api_url = 'https://checkout.globalmoney.cash/api/request';
    private $_checkout_url = 'https://checkout.globalmoney.cash/api/3/checkout';
    ...
    public function cnb_form($params)
    {
        ...
        return sprintf('
            <form method="POST" action="%s" accept-charset="utf-8">
                %s
                %s
                <input type="image" src="//static.globalmoney.cash/buttons/p1%s.radius.png" name="btn_text" />
            </form>
            ',
            $this->_checkout_url,
